...
ALFRED_ROOT = '/home/lxdlab/alfred'
sys.path.append(os.path.join(ALFRED_ROOT))
sys.path.append(os.path.join(ALFRED_ROOT, 'models'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--subgoal_aux_loss_wt', help='weight of subgoal completion predictor', default=0.1, type=float)
    parser.add_argument('--pm_aux_loss_wt', help='weight of progress monitor', default=0.1, type=float)
